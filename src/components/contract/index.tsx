    ...
    <div className="bg-card border border-dashed p-6 backdrop-blur-md">
      ...
      <div className="mt-6 border-t border-white/10 pt-4">
        <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
          <div className="flex justify-between">
            <span className="text-gray-300">{t('stats.contractAddress')}</span>
          ...
          <div className="flex justify-between">
            <span className="text-gray-300">{t('stats.network')}</span>
            <span className="text-white">{t('stats.polygonAmoy')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4">
        <div className="mb-2 flex justify-between text-sm text-gray-300">
          <span>{t('stats.stakingProgress')}</span>
        ...
        <p className="mt-1 text-xs text-gray-400">
          {totalStaked && totalSupply
            ? `${formatTokenAmount(totalStaked, 0)} of ${formatTokenAmount(totalSupply, 0)} ${t('stats.tokensStaked')}`
            : t('stats.loadingStakingData')}
        </p>
      </div>
    </div>
  )
