...
/**
 * @title NECTRToken
 * @dev ERC20 token with staking functionality
 * @notice This is a demo contract for the NECTR ecosystem
 */
contract NECTRToken is ERC20, Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public minimumStakeAmount = 10 * 10**decimals(); // 10 NECTR
